...
Module CrearBD
    ...
    Public StringBaseDatos As String = "
            ...
            INSERT INTO REVISORES(IDREVISOR,NOMBRECOMPLETO,DNI) 
            VALUES
            ...
            DIRECCION varchar(20) NOT NULL,
            IDREVISOR varchar(10) NOT NULL REFERENCES REVISORES (IDREVISOR),
            IDCLIENTE varchar(10) NOT NULL REFERENCES CLIENTES (IDCLIENTE)
            );

            INSERT INTO PEDIDOS(IDPEDIDO,FECHA,DIRECCION,IDREVISOR,IDCLIENTE) VALUES
            ...
            IDPRODUCTO varchar(10) NOT NULL REFERENCES EXTINTORES (IDEXTINTOR)
            );
